                    ...
                    !loading && !error && (
                        <div className='grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]'>
                            ...
                            <div className='lg:col-span-2'>
                                {data.isApproved==='pending' && (<div className='flex p-4 mb-4 text-yellowColor bg-yellow-50 rounded-lg'>
                                    <svg
                                        aria-hidden="true"
                                        ...
                                        <div className='flex items-center gap-4 mb-10'>
                                            ...
                                            <div>
                                               <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:py-2 lg:px-6 rounded text-[12px] leading-4 lg:text-[16px] lg:leading-6 font-semibold'>{data.specialization} </span>
                                                <h3 className='text-[22px] leading-9 font-bold text-headingColor'>{data.name}</h3>
