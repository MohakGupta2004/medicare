...
const Profile = ({doctorData})=>{
    const [formData, setFormData] = useState({
        ...
        specialization: "",
        ticketPrice: 0,
        qualifications: [{startingDate:' ',endingDate:' ',university: " ",
        degree: " "}],
        experiences:[{startingDate:'',endingDate:'',position: "",
        hospital: ""}],
    ...
    const addExperience=e=>{
        ...
        addItem('experiences',{
            startingDate:'',endingDate:'',position: "",
        hospital: ""
        })
    }
        ...
        <div>
            ...
            <form action="">
                <div className="mb-5">
                    ...
                    <input type="text" name="name" value={formData.name} onChange={handleInputChange} placeholder="Your Name" className="form__input"/>
                </div>
                <div className="mb-5">
                    <p className="form__label">Email*</p>
                    <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="Your Email" className="form__input" readOnly aria-readonly disabled='true'/>
                </div>
                <div className="mb-5">
                    <p className="form__label">Phone Number*</p>
                    <input type="number" name="number" value={formData.phone} onChange={handleInputChange} placeholder="Your Phone Number" className="form__input"/>
                </div>
                <div className="mb-5">
                    <p className="form__label">Bio*</p>
                    <input type="text" name="bio" value={formData.bio} onChange={handleInputChange} placeholder="Your Bio" className="form__input" maxLength={100}/>
                </div>
                        ...
                        <div className="grid grid-cols-3 gap-5 mb-[30px]">
                            ...
                            <div>
                                ...
                                <select name="specialization" value={formData.specialization} onChange={handleInputChange} className="form__input py-3.5">
                                    ...
                                    <option value="dermetologist">Dermetologist</option> I
                                </select>
                            </div>

                            <div>
                                <p className="form__label">Fees Charge Price*</p>
                    ...
                    <p className="form__label">Experiences*</p>
                        ...
                        <div>
                            <div className="grid grid-cols-2 gap-5">
                                ...
                                <button onClick={e=>deleteExperiences(e,index)} className="bg-purpleColor p-2 rounded-full text-[18px] mt-2 mb-[30px] cursor-pointer"><AiOutlineDelete/></button>
                    ...
                    <p className="form__label">Qualifications*</p>
                        ...
                        <div>
                            <div className="grid grid-cols-2 gap-5">
                                ...
                                <button onClick={e=>deleteQualification(e,index)} className="bg-purpleColor p-2 rounded-full text-[18px] mt-2 mb-[30px] cursor-pointer"><AiOutlineDelete/></button>
                ...
                <button className="btn" onClick={addQualification}>Add Qualification</button>
                    ...
                    <p className="form__label">Time Slots*</p>
                        ...
                        <div>
                            <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                                ...
                                <button onClick={e=>deleteTimeSlots(e,index)} className="bg-purpleColor p-2 rounded-full text-[18px] mb-[30px] cursor-pointer mt-6"><AiOutlineDelete/></button>
                ...
                <button onClick={addTimeSlot} className="btn">Add Timeslot</button>
                ...
                {formData.photo && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
                    ...
                    <div className="mt-7">
                        <button className="bg-primaryColor text-white text-[15px] leading-[30px] w-full py-3 px-4 rounded-lg" onClick={updateProfileHandler}>Update Profile</button>
                    </div>
            </form>
        </div>
    )
