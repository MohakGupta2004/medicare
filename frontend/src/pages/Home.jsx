...
import videoImg from '../../src/assets/images/video-icon.png'
            ...
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                ...
                <div>
                    <div className="lg:w-[570px]">
                        ...
                        <p className="text__para">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nesciunt, eos excepturi neque magnam facere in omnis molestias dolor quaerat atque nisi harum ex! Quibusdam corporis rem mollitia fugiat a. Qui!
                        </p>
        ...
        <div className="container">
            <div className="lg:w-[470px] mx-auto">
                ...
                <p className="text__para text-center">
                    Health care for everyone. Our health system offers unmatched, 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
                ...
                <div className="py-[30px] px-5">
                    ...
                    <div className="mt-[30px]">
                        ...
                        <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                            Find a location where you can meet your doctors who you will appoint.
                        </p>
                ...
                <div className="py-[30px] px-5">
                    <div className="flex items-center justify-center"><img src={icon03}  /></div>
                    <div className="mt-[30px]">
                        <h2 className="text-[26px] leading-9 text-headingColor font-[700] text-center">Book Appointment</h2>
                        <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                            Choose whom you want to consult and book an appointment with them.
                        </p>
    ...
    <section>
            <div className="container">
                <div className="xl:w-[470px] mx-auto">
                    ...
                    <p className="text__para text-center">We provide the following services for our users.
                    </p>
                </div>
                <ServicesList />
            </div>
            ...
            <div className="flex items-center justify-between flex-col lg:flex-row">
                <div className="xl:w-[670px]">
                    ...
                    <ul className="pl-4">
                        ...
                        <li className="text__para">
                            2.View our physicians who are accepting new patients, use the online scheduling tool to select an appointment time.
                        </li>
                        <li className="text__para">
                ...
                <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                    ...
                    <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                        ...
                        <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor">Bruce Wayne</h4>
                    </div>
                </div>
            </div>
            </div>
