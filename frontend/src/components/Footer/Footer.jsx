        ...
        <footer className="pb-16 pt-10">
            <div className="container">
                <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
                    <div>
                        <img src={logo} alt="" />
                        <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">Copyright  © {year} by Innoverian. All rights reserved.
                        </p>
                    ...
                    <div>
                        <h2 className="text-[20px] leading-[30px] font-[700px] mb-6 text-headingColor">
                            Quick Links
                        </h2>
